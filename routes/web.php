...
Route::delete('article/{slug}', [App\Http\Controllers\ArticleController::class, 'destroy'])->middleware('auth');
...
Route::delete('comment', [\App\Http\Controllers\CommentController::class, 'destroy'])->middleware('auth');
